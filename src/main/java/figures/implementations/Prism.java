...
//        float [] light2_position = {.7f, -.6f, 1.0f, -1.0f};
        ...
        glu.gluCylinder(quadric, .6f, .6f, 0.8f, verticesCount, 50);
        GLUquadric quadric1 = glu.gluNewQuadric();
        GLUquadric quadric2 = glu.gluNewQuadric();
        glu.gluDisk(quadric1, .0f, .6f, verticesCount, 10);
        gl.glTranslatef(0f, 0f, .8f);
        glu.gluDisk(quadric2, .0f, .6f, verticesCount, 10);
        gl.glTranslatef(0f, 0f, -.8f);
    ...
    public Figure withVertices(int verticesCount) {
        ...
        return super.withVertices(verticesCount);
    }
}
